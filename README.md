How to run: First run "make" in order to create the inodes file. Then run "./inodes <pathname>", where pathname is the path of the file you wish to make a graph of.
